...
void LineStat::createLabels(){
    cognome = new Label(tess->getCognome().toUpper(), this);
    cognome->setMinimumSize(100, 15);
    cognome->setAlignment(Qt::AlignVCenter);
    nome = new Label(tess->getNome(), this);
